...
import com.zhimadai.cctvmall.android_upload_service.service.ContactService;

import butterknife.BindView;
import butterknife.ButterKnife;
import butterknife.OnClick;

public class ContactServiceAct extends AppCompatActivity {
    ...
    private void permission() {
        ...
        helper = PermissionManager.with(ContactServiceAct.this)
                //添加权限请求码
                .addRequestCode(ContactServiceAct.REQUEST_CODE_CONTACT)
                //设置权限，可以添加多个权限
                ...
                .setPermissionsListener(new PermissionListener() {
                    ...
                    public void onGranted() {
                        //当权限被授予时调用
                        getIntents();
                        Toast.makeText(ContactServiceAct.this, "Storage Permission granted", Toast
                                .LENGTH_LONG).show();
                    }
                    ...
                    public void onDenied() {
                        //用户拒绝该权限时调用
                        Toast.makeText(ContactServiceAct.this, "Storage Permission denied", Toast
                                .LENGTH_LONG).show();
                    }
